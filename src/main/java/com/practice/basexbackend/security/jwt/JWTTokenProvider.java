...
import static com.practice.basexbackend.constant.Security.*;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(CustomUserDetails userPrincipal) {
        ...
        return JWT.create()
                .withIssuer(BASE_X_SPORTS_SC)
                .withAudience(BASE_X_ADMINISTRATION)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(BASE_X_SPORTS_SC).build();
